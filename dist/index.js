...
const TOOLS = [
    ...
    },
    {
        ...
        description: "Call after request_agentvisa, once you've relayed the message to your human. Waits up " +
...
const server = new Server({ name: "agentvisa", version: "0.5.0" }, { capabilities: { tools: {} } });
