...
if (!getAgentVisaToken()) {
    process.stderr.write("[AgentVisa MCP] No token configured yet (checked AGENTVISA_TOKEN env and " +
...
const TOOLS = [
    ...
    },
    {
        ...
        description: "Call this when NO AgentVisa token is configured (get_agentvisa_token returned " +
    ...
    },
    {
        ...
        description: "Call IMMEDIATELY after relaying request_agentvisa's message to your human, and DO NOT END " +
...
const server = new Server({ name: "agentvisa", version: "0.6.0" }, { capabilities: { tools: {} } });
...
server.setRequestHandler(CallToolRequestSchema, async (request) => {
    ...
    switch (name) {
                ...
                return {
                    content: [{
                            ...
                            text: JSON.stringify({
                                ...
                                message: "No AgentVisa token found (checked AGENTVISA_TOKEN env and " +
                        ...
                        return {
                            content: [{
                                    ...
                                    text: JSON.stringify({
                                        success: false,
                                        error: "rate_limited",
                                        message: "The AgentVisa API declined to issue a token right now (rate limited). " +
                ...
                return {
                    content: [{
                            ...
                            text: JSON.stringify({
                                ...
                                next: "Relay message_for_human to your human now (present the link as clickable). " +
        ...
        case "await_agentvisa_approval": {
            ...
            const WAIT_SECONDS = Math.max(10, Math.min(600, Number(process.env.AGENTVISA_WAIT_SECONDS ?? 240)));
                        ...
                        return {
                            content: [{
                                    ...
                                    text: JSON.stringify({
                                        ...
                                        message: "AgentVisa stored securely — the token was written to the token file and is " +
                ...
                return {
                    content: [{
                            ...
                            text: JSON.stringify({
                                ...
                                message: `Your human has not approved yet (waited ${WAIT_SECONDS}s). DO NOT END YOUR TURN and do ` +
